...
extension Clients {
  final class PolicyTroubleshooterLogging: PolicyTroubleshooterStub {
    let inner: any PolicyTroubleshooterStub
    let logger: Logger

    public init(_ inner: any PolicyTroubleshooterStub, logger: Logger) {
      var logger = logger
      logger[metadataKey: "gcp.artifact.id"] = "google-cloud-policytroubleshooter-iam-v3"
      logger[metadataKey: "gcp.client.service"] = "policytroubleshooter"
      logger[metadataKey: "gcp.experimental.swift.client"] = "PolicyTroubleshooter"
      self.inner = inner
      self.logger = logger
    }
