...
Add `swift-google-cloud-policytroubleshooter-iam-v3` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-policytroubleshooter-iam-v3.git --from 0.0.0-preview
```

Then add `GoogleCloudPolicyTroubleshooterIAMV3` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudPolicyTroubleshooterIAMV3 <target-name> --package swift-google-cloud-policytroubleshooter-iam-v3
```
